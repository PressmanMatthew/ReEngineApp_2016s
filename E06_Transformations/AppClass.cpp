...
void AppClass::InitVariables(void)
{
	...
	m_pCylinder->GenerateCylinder(.5f, .5f, 10, REBLUE);
	m_pCone->GenerateCone(.5f, .5f, 10, REGREEN);
	m_pTube->GenerateTube(.5f, .25f, .5f, 10, REBROWN);
	m_pTorus->GenerateTorus(0.5f, .25f, 10, 10, REYELLOW);
}
...
void AppClass::Update(void)
{
	...
	m_m4Cylinder = glm::scale(m_m4Cylinder, vector3(2.0f, 2.0f, 1.0f));
	m_m4Cone = glm::scale(m_m4Cone, vector3(2.0f, 2.0f, 1.0f));
	m_m4Tube = glm::scale(m_m4Tube, vector3(2.0f, 2.0f, 1.0f));
	m_m4Torus = glm::scale(m_m4Torus, vector3(2.0f, 2.0f, 1.0f));
