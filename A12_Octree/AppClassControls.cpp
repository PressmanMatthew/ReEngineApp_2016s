...
#pragma region ON PRESS/RELEASE DEFINITION
	static bool	bLastF1 = false, bLastF2 = false, bLastF3 = false, bLastF4 = false, bLastF5 = false,
				...
				bLastEscape = false, bLastF = false, bLastO = true, bLastP = true, bLastI = false;
...
#pragma region Other Actions
	...
	ON_KEY_PRESS_RELEASE(O, NULL, viewOctree = !viewOctree);
	ON_KEY_PRESS_RELEASE(P, NULL, spatialOpt = !spatialOpt);
