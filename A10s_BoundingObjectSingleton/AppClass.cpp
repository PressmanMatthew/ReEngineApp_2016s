...
void AppClass::Update(void)
{
	...
	//std::cout << m_pBOMngr->GetBoundingObject(0)->GetHalfWidth().x << ", " << m_pBOMngr->GetBoundingObject(0)->GetHalfWidth().y << ", " << m_pBOMngr->GetBoundingObject(0)->GetHalfWidth().z << std::endl;
	//std::cout << m_pBOMngr->GetBoundingObject(0)->GetHalfWidthG().x << ", " << m_pBOMngr->GetBoundingObject(0)->GetHalfWidthG().y << ", " << m_pBOMngr->GetBoundingObject(0)->GetHalfWidthG().z << std::endl;
